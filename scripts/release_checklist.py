...
STEPS = [
    ...
    ("Coloring",
     "Toggle 'Log color scale'.",
     "Colour distribution changes noticeably; image stays coherent."),
    ("Coloring",
    ...
    ("Locations",
     "Navigate > Bookmarks > Manage… - rename and delete a bookmark.",
     "Manager opens, edits apply, deletion works, list stays consistent."),
    ("Locations",

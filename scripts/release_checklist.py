...
STEPS = [
    ...
    ("Layout & theme",
     ...
     "(Not automated: the harness does not drive individual CollapsingHeaders. The panel's presence "
     "and non-overlap ARE checked by uitest:layout-regions.)"),
    ("Layout & theme",
...
ENFORCERS = [
    ("Launch", "partial:uitest:no-crash-files"),
    ("Launch", "test:title_string_matches_version"),
    ("Launch", "test:welcome_shows_once"),
    ("Launch", "selftest:home"),
    ("Layout & theme", "uitest:layout-regions"),
    ("Layout & theme", "partial:test:every_ui_glyph_has_a_font_that_can_draw_it"),
    ("Layout & theme", "partial:test:theme_contrast_meets_minimum"),
    ("Layout & theme", "uitest:status-bar-populated"),
    ("Layout & theme", "manual"),
    ("Layout & theme", "uitest:panel-toggle-reflows"),
    ("Window sizing", "partial:uitest:layout-regions"),
    ("Window sizing", "partial:uitest:layout-regions"),
    ("Window sizing", "uitest:window-maximize-restore"),
    ("Window sizing", "uitest:window-rapid-resize"),

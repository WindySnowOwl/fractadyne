...
The full font is ~840 KB for 2035 icons; we use 29. Subsetting keeps the binary small and, more
...
for const, name, use in ICONS:
    ...
    lines.append("")
io.open(os.path.join(REPO, r"crates\fractadyne-app\src\icons.rs"), "w",

...
`[selftest …ms]` streamed check results.
...
- **Byte-identical output across a shader "fix"** → the changed code did not execute; see
  the WGSL NaN lesson in design/diagnostics.md (F4). Counters (phase D3) are the detector.

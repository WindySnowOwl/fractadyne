...
pub(crate) const CLI_REFERENCE: &[CliRef] = {
    ...
    &[
        ...
        Flag("--benchmark-std [--res R] [--burnin N]", "Standardized benchmark: pinned resolution + settings, comparable across machines. --res = 720p | 1080p | 4k | 5k (default 1080p). --burnin N repeats it N times (default 10) to check stability / throttling."),
